...
function ocultarTodo(){
    ...
    document.getElementById('p22').classList.remove('dflex');
    document.getElementById('p22').classList.add('esconder');
    document.getElementById('p23').classList.remove('dflex');
    document.getElementById('p23').classList.add('esconder');
    document.getElementById('p24').classList.remove('dflex');
    document.getElementById('p24').classList.add('esconder');
    document.getElementById('p25').classList.remove('dflex');
    document.getElementById('p25').classList.add('esconder');
    document.getElementById('p26').classList.remove('dflex');
    document.getElementById('p26').classList.add('esconder');
    document.getElementById('p27').classList.remove('dflex');
    document.getElementById('p27').classList.add('esconder');
}
/**
 * rango de los campos a rellenar TOTAL 27 ya que no se cuenta el del creador
...
function mostrarPaso(paso){
    for(var a=1;a<=7;a++){
        if(a!=paso){
            document.getElementById('pasoE'+String(a)).classList.add('fondoNegro');
            document.getElementById('pasoE'+String(a)).classList.remove('fondoSeleccion');
        }else{
            document.getElementById('pasoE'+String(a)).classList.remove('fondoNegro');
            document.getElementById('pasoE'+String(a)).classList.add('fondoSeleccion');
        }
    }
}
